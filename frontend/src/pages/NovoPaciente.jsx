...
function Secao({ numero, titulo, subtitulo, children }) {
  return (
    <fieldset style={{ border: "none", padding: 0, margin: 0 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "0.85rem 1rem" }}>{children}</div>
    </fieldset>
  );
}
...
export default function NovoPaciente({ aoSalvar, aoCancelar }) {
  ...
  return (
    <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 12, padding: "1.75rem", width: "100%" }}>
      <h2 style={{ fontSize: "1.15rem", marginBottom: "1.25rem" }}>Novo paciente</h2>
      <form onSubmit={enviar} style={{ display: "flex", flexDirection: "column", gap: "1.75rem" }}>
